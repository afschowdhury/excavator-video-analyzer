...
class HTMLAssemblerAgent(BaseAgent):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.use_ai = self.config.get("use_ai", True)  # Allow disabling AI generation
    ...
    def _generate_with_ai(
        ...
        prompt = f"""Generate a professional HTML report for excavator operator training analysis.
...
2. Use a professional, modern design with clean typography
3. Include all sections from the provided data
4. Use tables for metrics, cards for scores, and clear section headers
5. Make it print-friendly with good page breaks
6. Include the SI matrix table and control usage distribution
7. Display images if available (use img tags with data URIs)
8. Use color coding: green for good, yellow for moderate, red for needs improvement
9. Make it responsive and mobile-friendly
10. Follow best practices for HTML5 and CSS3
...
<body>
    ...
    def _build_insights_section(self, insights: Dict[str, Any]) -> str:
        ...
        <section class="insights">
            <h2>4. AI-GENERATED INSIGHTS & RECOMMENDATIONS</h2>
...
"""
        ...
        joystick_summary = f"""
**Joystick Analytics:**
- Total Actions: {js.get('total_actions', 0)}
- Smoothness Index: {js.get('smoothness_index', 0):.1f}%
- Efficiency Score: {js.get('efficiency_score', 0):.1f}%
- Simultaneous Usage: {js.get('simultaneous_usage_percentage', 0):.1f}%
"""
