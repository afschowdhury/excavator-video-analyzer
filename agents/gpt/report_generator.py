...
class ReportGeneratorAgent(BaseAgent):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        prompt_config = self.prompt_manager.get_prompt_config("report_generator")
        ...
        self.max_tokens = prompt_config.get("max_tokens", 3000)
        
        # Get system prompt
        self.system_prompt = self.prompt_manager.get_prompt("report_generator")
